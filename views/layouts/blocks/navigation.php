...
<ul class="x-navigation x-navigation-horizontal x-navigation-panel">
    ...
    <li class="xn-icon-button">
        <a href="#" class="x-navigation-minimize"><span
    ...
    <li class="xn-icon-button pull-right last">
        ...
        <ul class="xn-drop-left animated zoomIn">
            <li><a href="pages-lock-screen.html"><span
                            class="fa fa-lock"></span> Lock Screen</a></li>
        ...
        <div class="panel panel-primary animated zoomIn xn-drop-left xn-panel-dragging">
            ...
            <div class="panel-body list-group list-group-contacts scroll"
                ...
                <a href="#" class="list-group-item">
                    ...
                    <img src="/img/users/user2.jpg" class="pull-left"
                         alt="John Doe"/>
                ...
                <a href="#" class="list-group-item">
                    ...
                    <img src="/img/users/user.jpg" class="pull-left"
                         alt="Dmitry Ivaniuk"/>
                ...
                <a href="#" class="list-group-item">
                    <div class="list-group-status status-away"></div>
                    <img src="/img/users/user3.jpg" class="pull-left"
                         alt="Nadia Ali"/>
                ...
                <a href="#" class="list-group-item">
                    ...
                    <img src="/img/users/user6.jpg" class="pull-left"
                         alt="Darth Vader"/>
    ...
    <li class="xn-icon-button pull-right">
        ...
        <div class="panel panel-primary animated zoomIn xn-drop-left xn-panel-dragging">
            <div class="panel-heading">
                <h3 class="panel-title"><span class="fa fa-tasks"></span> Tasks
                </h3>
                <div class="pull-right">
            ...
            <div class="panel-body list-group scroll" style="height: 200px;">
                <a class="list-group-item" href="#">
                    ...
                    <small class="text-muted">John Doe, 25 Sep 2015 / 50%
                    </small>
                </a>
                <a class="list-group-item" href="#">
                    ...
                    <small class="text-muted">Dmitry Ivaniuk, 24 Sep 2015 /
                        80%
                    </small>
                </a>
                <a class="list-group-item" href="#">
                    ...
                    <small class="text-muted">John Doe, 23 Sep 2015 / 95%
                    </small>
                </a>
                <a class="list-group-item" href="#">
    ...
    <!-- LANG BAR -->
    <li class="xn-icon-button pull-right">
        <a href="#"><span class="flag flag-ru"></span></a>
